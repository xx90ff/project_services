<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\phpstudy_pro\WWW\project_services\public/../application/admin\view\goods\edit.html";i:1615357655;s:79:"D:\phpstudy_pro\WWW\project_services\application\admin\view\layout\default.html";i:1611580233;s:76:"D:\phpstudy_pro\WWW\project_services\application\admin\view\common\meta.html";i:1611580233;s:78:"D:\phpstudy_pro\WWW\project_services\application\admin\view\common\script.html";i:1611580233;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
        ...
        <div class="col-xs-12 col-sm-8">
            <select  id="c-category_id" data-rule="required" class="form-control selectpicker" name="row[category_id]">
                <?php if(is_array($options) || $options instanceof \think\Collection || $options instanceof \think\Paginator): if( count($options)==0 ) : echo "" ;else: foreach($options as $key=>$vo): ?>
                    <option value="<?php echo $vo['id']; ?>" <?php if(($vo['id'] == $row['category_id'])): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-weigh" class="form-control" min="0" name="row[weigh]" type="number" value="<?php echo $row['weigh']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-stock" class="form-control" min="0" name="row[stock]" type="number" value="<?php echo $row['stock']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-price" class="form-control" min="0" step="0.01" name="row[price]" type="number" value="<?php echo $row['price']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cycle" class="form-control" name="row[cycle]" type="text" value="<?php echo $row['cycle']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-usenum" class="form-control" min="0" name="row[usenum]" type="number" value="<?php echo $row['usenum']; ?>">
        </div>
    </div>
