<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"D:\phpstudy_pro\WWW\project_services\public/../application/admin\view\category\edit.html";i:1615347603;s:79:"D:\phpstudy_pro\WWW\project_services\application\admin\view\layout\default.html";i:1611580233;s:76:"D:\phpstudy_pro\WWW\project_services\application\admin\view\common\meta.html";i:1611580233;s:78:"D:\phpstudy_pro\WWW\project_services\application\admin\view\common\script.html";i:1611580233;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select  id="c-category_id" data-rule="required" class="form-control selectpicker" name="row[category_id]">
                <option value="0"><?php echo __('Category top'); ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['hidden' => __('hidden'), 'normal' => __('normal')], $row['status']); ?>
        </div>
    </div>
